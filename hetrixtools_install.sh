...
if curl -sf --head "https://raw.githubusercontent.com/andreizy/dev-mac-os/$BRANCH/hetrixtools_agent.sh" > /dev/null 2>&1
then
...
if ! curl -sf -o /opt/hetrixtools/hetrixtools_agent.sh "https://raw.githubusercontent.com/andreizy/dev-mac-os/$BRANCH/hetrixtools_agent.sh"
then
...
if ! curl -sf -o /opt/hetrixtools/hetrixtools.cfg "https://raw.githubusercontent.com/andreizy/dev-mac-os/$BRANCH/hetrixtools.cfg"
then
...
if ! curl -sf -o /opt/hetrixtools/run_agent.sh "https://raw.githubusercontent.com/andreizy/dev-mac-os/$BRANCH/run_agent.sh"
then
