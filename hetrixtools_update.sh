...
if ! curl -sf -o "$AGENT" "https://raw.githubusercontent.com/andreizy/dev-mac-os/$BRANCH/hetrixtools_agent.sh"
then
...
if ! curl -sf -o "$CONFIG" "https://raw.githubusercontent.com/andreizy/dev-mac-os/$BRANCH/hetrixtools.cfg"
then
